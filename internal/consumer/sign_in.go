...
import (
	...
	IConsumerBiz "github.com/goclub/project-seckilling/internal/merchant/interface"
...
func (dep Biz) ConsumerSignIn(
	ctx context.Context,
	data IConsumerBiz.ConsumerSignIn,
	) (consumerID pd.IDConsumer, reject error) {
	// 格式验证
